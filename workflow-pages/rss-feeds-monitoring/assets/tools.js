...
window.NEBOR_TOOLS = {
  ...
  pipedrive:  { name: "Pipedrive",      color: "#1A1A1A", img: "./assets/tools/pipedrive.webp",
  ...
  lemlist:    { name: "Lemlist",        color: "#0E2A5A", img: "./assets/tools/lemlist.webp",
  ...
  leadmagic:  { name: "LeadMagic",      color: "#6C4DF6", img: "./assets/tools/leadmagic.webp",
  ...
  fullenrich: { name: "FullEnrich",     color: "#1F2937", img: "./assets/tools/fullenrich.webp",
