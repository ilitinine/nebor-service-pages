...
(function () {
  ...
  const views = {
    // 01 · Demand Strategy & Channel Mapping · THE FAN, framed: buyers at the base of one big panel,
    //      channels orbit by grade, a re-graded channel shown mid-move. No window chrome.
    strategy: () => `
      <div class="rec-viz">
      <svg viewBox="0 0 700 412" preserveAspectRatio="xMidYMid meet" aria-hidden="true" font-family="var(--font-sans)">
        ...
        <g class="cap-layer">
          ...
          <path d="M70 147 A 670 670 0 0 1 630 147" fill="none" stroke="rgba(23,42,45,0.09)" stroke-width="1.4" stroke-dasharray="2 5"/>
          <path d="M100 244 A 570 570 0 0 1 600 244" fill="none" stroke="rgba(23,42,45,0.10)" stroke-width="1.4"/>
          <path d="M150 331 A 470 470 0 0 1 550 331" fill="none" stroke="rgba(225,150,46,0.35)" stroke-width="1.4"/>
          <g opacity="0.5"><animateTransform attributeName="transform" type="rotate" values="-62 350 336;62 350 336;-62 350 336" dur="11s" repeatCount="indefinite"/>
            <line x1="350" y1="336" x2="350" y2="94" stroke="url(#swp)" stroke-width="2"/>
            <circle cx="350" cy="94" r="3" fill="#E1962E" opacity="0.7"/>
          </g>
          <text x="46" y="106" font-size="8.5" font-weight="800" letter-spacing="0.07em" fill="rgba(23,42,45,0.4)">SKIP</text>
          <text x="46" y="117" font-size="6.8" fill="rgba(23,42,45,0.45)">they ignore these</text>
          <text x="46" y="192" font-size="8.5" font-weight="800" letter-spacing="0.07em" fill="rgba(23,42,45,0.55)">SUPPORT</text>
        ...
        <g class="cap-layer" style="animation-delay:0.06s">
          ...
          <g transform="translate(149,202)"><circle cx="7" cy="7" r="6.4" fill="none" stroke="rgba(23,42,45,0.72)" stroke-width="1.4"/><path d="M5.6 4.6 L9.8 7 L5.6 9.4 Z" fill="rgba(23,42,45,0.72)"/></g>
          <text x="169" y="213" font-size="8.6" font-weight="700" fill="#172A2D">Webinars</text>
        </g>
          <g opacity="0"><animate attributeName="opacity" from="0" to="1" dur="0.45s" begin="0.38s" fill="freeze"/>
          <rect x="246" y="175" width="100" height="28" rx="9" fill="#FCFAF7" stroke="#FFFFFF" stroke-width="1.6" filter="drop-shadow(0 4px 10px rgba(23,42,45,0.08))"/>
          <g transform="translate(255,182)"><path d="M1 1.5 h12 v8 h-6.5 l-3 3 v-3 H1 Z" fill="none" stroke="rgba(23,42,45,0.72)" stroke-width="1.4" stroke-linejoin="round"/></g>
          <text x="275" y="193" font-size="8.6" font-weight="700" fill="#172A2D">Communities</text>
        </g>
          <g opacity="0"><animate attributeName="opacity" from="0" to="1" dur="0.45s" begin="0.46s" fill="freeze"/>
          <rect x="354" y="175" width="100" height="28" rx="9" fill="#FCFAF7" stroke="#FFFFFF" stroke-width="1.6" filter="drop-shadow(0 4px 10px rgba(23,42,45,0.08))"/>
          <g transform="translate(363,182)"><rect x="0.7" y="2" width="12.6" height="10" rx="1.6" fill="none" stroke="rgba(23,42,45,0.72)" stroke-width="1.4"/><path d="M1 3 L7 8 L13 3" fill="none" stroke="rgba(23,42,45,0.72)" stroke-width="1.4" stroke-linejoin="round"/></g>
          <text x="383" y="193" font-size="8.6" font-weight="700" fill="#172A2D">Newsletters</text>
        </g>
          <g opacity="0"><animate attributeName="opacity" from="0" to="1" dur="0.45s" begin="0.54s" fill="freeze"/>
          <rect x="460" y="195" width="100" height="28" rx="9" fill="#FCFAF7" stroke="#FFFFFF" stroke-width="1.6" filter="drop-shadow(0 4px 10px rgba(23,42,45,0.08))"/>
          <g transform="translate(469,202)"><path d="M5.2 8.6 a3.4 3.4 0 0 1 0 -4.8 l1.8 -1.8 a3.4 3.4 0 0 1 4.8 4.8 l-1 1" fill="none" stroke="rgba(23,42,45,0.72)" stroke-width="1.5" stroke-linecap="round"/><path d="M8.8 5.4 a3.4 3.4 0 0 1 0 4.8 l-1.8 1.8 a3.4 3.4 0 0 1 -4.8 -4.8 l1 -1" fill="none" stroke="rgba(23,42,45,0.72)" stroke-width="1.5" stroke-linecap="round"/></g>
        ...
        <g class="cap-layer" style="animation-delay:0.12s">
          ...
          <rect x="134" y="290" width="132" height="42" rx="12" fill="#FCFAF7" stroke="#FFFFFF" stroke-width="2" filter="drop-shadow(0 8px 16px rgba(23,42,45,0.14))"/>
